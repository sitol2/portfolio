...
// ── Variant 2: Zoom + brightness burst ──
...
// ── Variant 5: Spin + directional drift ──
...
// ── Variant 6: Speed-reactive size + blur ──
...
// ── USAGE: <ImageTrail items={[...]} variant={7} /> ──
// Change the `variant` prop to switch (1–7)
